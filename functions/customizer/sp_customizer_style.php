...
function solopine_customizer_css() {
    ...
    <style type="text/css">
		...
		a, .author-content a.author-social:hover, .woocommerce .star-rating { color:<?php echo get_theme_mod( 'sp_color_accent' ); ?>; }
		.more-button:hover, .post-share a i:hover, .post-pagination a:hover, .pagination a:hover, .widget .tagcloud a, .side-count, .cart-contents .sp-count { background:<?php echo get_theme_mod( 'sp_color_accent' ); ?>; }
