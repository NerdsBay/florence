...
function solopine_load_scripts() {
	...
	wp_enqueue_script('sp_retina', get_template_directory_uri() . '/js/retina.min.js', array( 'jquery' ), '', true);
	
	// Fonts
	wp_enqueue_style('default_headings_font', '//fonts.googleapis.com/css?family=Oswald:400,700');
	wp_enqueue_style('default_para_font', '//fonts.googleapis.com/css?family=Crimson+Text:400,700,400italic,700italic');
	wp_enqueue_style('default_body_font', '//fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,400,700&subset=cyrillic,latin');
...
if ( function_exists('register_sidebar') ) {
	...
	register_sidebar(array(
		...
		'after_title' => '</h4>',
		'description' => esc_html__('Use the Instagram widget here. IMPORTANT: For best result set number of images to 8', 'solopine'),
	));
}
